...
//ashwinm #define HAS_DISKS	/* uses disk images */
//ashwinm #define HAS_CONFIG	/* has configuration files somewhere */
...
#define LCD_EMU
#define LOG_LCD_MEM
#define LCD_WIN_X_START ((320-256)/2)
#define LCD_WIN_X_END	(LCD_WIN_X_START + 256 - 1)
#define LCD_WIN_Y_START	((240-192)/2)
#define LCD_WIN_Y_END	(LCD_WIN_Y_START + 192 - 1)
